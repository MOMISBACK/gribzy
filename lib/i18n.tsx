...
const en = {
  ...
  'library.rename': 'Rename', 'library.delete': 'Delete', 'common.cancel': 'Cancel', 'common.save': 'Save', 'common.close': 'Close',
  ...
  'import.partialTitle': 'Limited GRIB support', 'import.partialText': 'This GRIB file is only partially supported. Compatible weather layers were kept.',
  'import.unsupportedTitle': 'Unsupported GRIB file', 'import.unsupportedText': 'No compatible weather layer was found. The file was not added to your library.',
  'import.available': 'Available', 'import.unavailable': 'Unavailable',
  'import.pressure': 'Mean sea level pressure', 'import.wind': '10 m wind',
  'import.technicalDetails': 'Technical details', 'import.copyDetails': 'Copy technical details',
  'import.copied': 'Technical details copied', 'import.openAvailable': 'Open available layers',
  'import.moreIssues': '+{count} more incompatibilities',
  ...
  'select.selectedArea': 'Selected area',
  'select.zoomIn': 'Zoom in to download',
  ...
  'map.pressureMissing': 'Pressure message not found', 'map.unsupportedGrib': 'This GRIB file uses a grid or field type that Gribzy does not support yet.', 'map.parameterA11y': 'Choose weather parameter',
  ...
  'map.timelineA11y': 'Available forecast timeline', 'map.oneForecast': '1 forecast',
  'map.previousForecast': 'Previous forecast', 'map.nextForecast': 'Next forecast',
  'map.loadingForecast': 'Loading…', 'map.frameUnavailable': 'This forecast time could not be loaded.',
  'map.pressureUnavailable': 'Pressure unavailable', 'map.windUnavailable': 'Wind unavailable', 'map.layerUnavailable': 'Unavailable',
  ...
  'settings.mapData': 'Map data', 'settings.mapAttribution': '© OpenMapTiles · © OpenStreetMap',
...
const fr: Record<TranslationKey, string> = {
  ...
  'library.rename': 'Renommer', 'library.delete': 'Supprimer', 'common.cancel': 'Annuler', 'common.save': 'Enregistrer', 'common.close': 'Fermer',
  ...
  'import.partialTitle': 'Prise en charge GRIB limitée', 'import.partialText': 'Ce fichier GRIB n’est que partiellement compatible. Les couches météo compatibles ont été conservées.',
  'import.unsupportedTitle': 'Fichier GRIB non compatible', 'import.unsupportedText': 'Aucune couche météo compatible n’a été trouvée. Le fichier n’a pas été ajouté à la bibliothèque.',
  'import.available': 'Disponible', 'import.unavailable': 'Indisponible',
  'import.pressure': 'Pression au niveau moyen de la mer', 'import.wind': 'Vent à 10 m',
  'import.technicalDetails': 'Détails techniques', 'import.copyDetails': 'Copier les détails techniques',
  'import.copied': 'Détails techniques copiés', 'import.openAvailable': 'Ouvrir les couches disponibles',
  'import.moreIssues': '+{count} autres incompatibilités',
  ...
  'select.selectedArea': 'Zone sélectionnée',
  'select.zoomIn': 'Zoomez pour télécharger',
  ...
  'map.pressureMissing': 'Message pression non trouvé', 'map.unsupportedGrib': 'Ce fichier GRIB utilise un type de grille ou de champ que Gribzy ne prend pas encore en charge.', 'map.parameterA11y': 'Choisir le paramètre météo',
  ...
  'map.timelineA11y': 'Timeline des échéances disponibles', 'map.oneForecast': '1 échéance',
  'map.previousForecast': 'Échéance précédente', 'map.nextForecast': 'Échéance suivante',
  'map.loadingForecast': 'Chargement…', 'map.frameUnavailable': 'Cette échéance n’a pas pu être chargée.',
  'map.pressureUnavailable': 'Pression indisponible', 'map.windUnavailable': 'Vent indisponible', 'map.layerUnavailable': 'Indisponible',
  ...
  'settings.mapData': 'Données cartographiques', 'settings.mapAttribution': '© OpenMapTiles · © OpenStreetMap',
